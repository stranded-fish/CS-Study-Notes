...
更多内容：[LeetCode 题解：二叉树的后序遍历变形](https://leetcode-cn.com/problems/binary-tree-cameras/solution/dfs-hou-xu-bian-li-tan-xin-chao-jian-ji-1t0r1/)
...
> **Tips:** 运用递归来解决树的问题时，如果涉及到树的修改，则需要返回 TreeNode，并用对象进行接收
> TODO
